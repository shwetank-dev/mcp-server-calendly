...
export const ListScheduledEventsSchema = z.object({
  ...
  min_start_time: z.string().optional().describe('Filter: events starting after this ISO 8601 time'),
  max_start_time: z.string().optional().describe('Filter: events starting before this ISO 8601 time'),
});
...
export const CheckAvailabilitySchema = z.object({
  event_type_uri: z.string().describe('URI of the event type to check availability for'),
